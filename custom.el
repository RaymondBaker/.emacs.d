...
(custom-set-variables
 ...
 '(package-selected-packages
   '(w3m sclang undo-fu ivy vue-mode jinx modus-themes shell-pop shell-pop-el treemacs-icons-dired treemacs-evil treemacs envrc exec-path-from-shell pet treesit-auto flycheck company lsp-pyright pip-requirements pyvenv lsp-ui lsp-mode undo-fu-session evil-collection evil-surround evil)))
(custom-set-faces
